            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <motion.div
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-wrap justify-between">
                            <div className="text-sm text-gray-400">2017.03~2018.06</div>
                            <div className="text-sm text-gray-400">(1년 4개월)</div>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-wrap justify-between">
                            <div className="text-sm text-gray-400">2013.11-2015.03</div>
                            <div className="text-sm text-gray-400">(1년 5개월)</div>
                        </div>
                    </div>
                </motion.div>
            </div>
